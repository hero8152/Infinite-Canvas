(function(){
    ...
    window.StudioI18n.register({
        ...
        "smart.drawThingsLora": { zh: "DT_Lora", en: "DT_Lora" },
        "smart.drawThingsLoraNone": { zh: "不加载Lora", en: "Do not load LoRA" },
        "smart.drawThingsLoraWeight": { zh: "DT_Lora强度", en: "DT_Lora strength" },
        "smart.drawThingsLoraEmpty": { zh: "未检测到Lora模型", en: "No LoRA models detected" },
        "smart.drawThingsLoraIncompatible": { zh: "当前模型与该Lora不兼容：{model} / {lora}", en: "The selected model is incompatible with this LoRA: {model} / {lora}" },
        ...
        "smart.errDrawThingsMaskModel": { zh: "当前 Draw Things 模型不支持遮罩编辑，请切换到 Klein 或 Qwen Edit 模型", en: "The selected Draw Things model does not support mask editing. Switch to a Klein or Qwen Edit model" },
